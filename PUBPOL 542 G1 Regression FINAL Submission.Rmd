...
>Comments on Linear Regression: models 2 and 3 had a much higher r-squared than model 1, so our choice will fall between those two.  Model 3 was chosen because it predicts the variance in our outcome similarly to Model 2. Model 3 will be used going forward.  
